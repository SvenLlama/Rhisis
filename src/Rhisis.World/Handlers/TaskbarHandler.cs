...
namespace Rhisis.World.Handlers
{
    ...
    public sealed class TaskbarHandler
    {
        ...
        public void OnAddTaskbarApplet(IWorldClient client, AddTaskbarAppletPacket packet)
        {
            ...
            _taskbarSystem.AddShortcutToAppletTaskbar(client.Player, shortcutToAdd);
        }
        ...
        {
            _taskbarSystem.RemoveShortcutFromAppletTaskbar(client.Player, packet.SlotIndex);
        }
        ...
        public void OnAddTaskbarItem(IWorldClient client, AddTaskbarItemPacket packet)
        {
            ...
            _taskbarSystem.AddShortcutToItemTaskbar(client.Player, shortcutToAdd, packet.SlotLevelIndex);
        }
        ...
        {
            _taskbarSystem.RemoveShortcutFromItemTaskbar(client.Player, packet.SlotLevelIndex, packet.SlotIndex);
        }
    }
}